...
internal class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PurchaseInvoice>().Property(x => x.TotalAmount).HasDefaultValue(0.0m);
        ...
        modelBuilder.Entity<SalesInvoice>().Property(x => x.InvoiceDate).HasDefaultValueSql("GETDATE()").ValueGeneratedOnAdd()
            .Metadata.SetAfterSaveBehavior(PropertySaveBehavior.Ignore);
        modelBuilder.Entity<SalesInvoice>().Property(x => x.TotalAmount).HasDefaultValue(0.0m);
        ...
        modelBuilder.Entity<SalesDetail>().Property(x => x.Discount).HasDefaultValue(0.0m);
